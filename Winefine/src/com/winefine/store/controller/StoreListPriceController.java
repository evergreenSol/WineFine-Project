...
/**
 * Servlet implementation class StoreListPriceController
 */
@WebServlet("/store.th_price")
public class StoreListPriceController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public StoreListPriceController() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Product> list = new ProductService().sortProductPrice(pn);
		...
		request.getRequestDispatcher("views/store/storeThumbnailList_price.jsp").forward(request, response);
	}
