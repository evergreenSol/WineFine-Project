<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <head>
        ...
        #insert-form input, #insert-form textarea, #insert-form img { 
            width: 70%;
            height: 100%;
            box-sizing: border-box;    
        }
       ...
       <div class="wrap">
           ...
           <div class="w_ top">
               ...
               <div class="w_" style="height: 90px;">
                    ...
                    <table>
                    <tr id="top_btn">
                            <td style="width:480px; font-size: 22px; font-weight: 600">이벤트 작성하기</td>
           ...
           <div class="w_ body">
            ...
            <div outer="outer" align="center">
                <br>
                <form id="insert-form" action="<%= contextPath %>/insert.ev" method="post" enctype="multipart/form-data">
                    
                    <input type="hidden" name="userNo" value="<%= loginUser.getUserNo() %>">
                    <table>
                        <tr>
                            <th width="100" align="right">시작날짜</th>
                            <td width="600" align="center"><input type="date" id="startDate" name="startDate" required></td>
                        </tr>
                        <tr>
                            <th width="100" align="right">종료날짜</th>
                            <td width="600" align="center"><input type="date" id="endDate" name="endDate" required></td>
                        </tr>
                        <tr>
                            <th width="100" align="right">제목</th>
                            <td width="600" align="center"><input type=text name="title" placeholder="제목을 입력하세요." required></td>
                        </tr>
                        <tr>
                            <th width="100" align="right">썸네일이미지</th>
                            <td height="200" align="center"><img id="thumbnail"></td>
                        </tr>
                        <tr>
                        	<th width="100" align="right">상세이미지</th>
                            <td height="600" align="center"><img id="contentPhoto"></td>
                        </tr>
                    </table>
                    <div id="file-area">
