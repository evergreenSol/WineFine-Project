...
public final class pay_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	//System.out.println("pay.jsp : " + totalPrice);
      ...
      out.write("<body>\r\n");
      out.write("	\r\n");
      out.write("    <!-- 다음페이지로 넘길 정보들-------------------------------------------------- -->\r\n");
      out.write("    <form id=\"present\" action=\"/insertOrder.me\" method=\"post\">\r\n");
      out.write("        <input type=\"hidden\" id=\"pickup\" name=\"pickup\" value=\"");
      out.print( pickup );
      out.write("\">\r\n");
      out.write("        <input type=\"hidden\" id=\"locationCode\" name=\"locationCode\" value=\"");
      out.print( locationCode );
      out.write("\">\r\n");
      out.write("        <input type=\"hidden\" id=\"pickupDate\" name=\"pickupDate\" value=\"");
      out.print( pickupDate );
      out.write("\">\r\n");
      out.write("        <input type=\"hidden\" id=\"paymentCode\" name=\"paymentCode\" value=\"");
      out.print( paymentCode );
      out.write("\">\r\n");
      ...
      out.write("    <script>\r\n");
      out.write("        $(function(){\r\n");
      out.write("            $(\"#present\").submit(function(){\r\n");
      out.write("                var pickup = $(\"#pickup\").val();\r\n");
      out.write("                var locationName = $(\"#locationName\").val();\r\n");
      out.write("                var orderDate = $(\"#orderDate\").val();\r\n");
      out.write("                var payment = $(\"#payment\").val();\r\n");
      out.write("                var totalPrice = $(\"#totalPrice\").val();\r\n");
      out.write("                //var name = $(\"#name\").val();\r\n");
      out.write("                //$(\"#inputData\").append('<p>' + '이름: '+ name + '</p>');\r\n");
      out.write("                //var email = $(\"#email\").val();\r\n");
      out.write("                //$(\"#inputData\").append('<p>' + '이메일: ' + email + '</p>');\r\n");
      out.write("                return false; // false는 왜 리턴해주는가???????????????????????????????????????????\r\n");
      ...
      out.write("        IMP.init('imp54187810'); // 'iamport' 대신 부여받은 \"가맹점 식별코드\"를 사용\r\n");
      out.write("        var msg;\r\n");
      out.write("        \r\n");
      out.write("        IMP.request_pay({\r\n");
      out.write("            pg : 'kakaopay',\r\n");
      out.write("            pay_method : 'card',\r\n");
      out.write("            merchant_uid : 'wine_' + new Date().getTime(),\r\n");
      out.write("            name : 'WINE FINE',\r\n");
      out.write("            amount : ");
      out.print(totalPrice);
      out.write(", \r\n");
      ...
      out.write("                    }\r\n");
      out.write("                });\r\n");
      out.write("                //성공시 이동할 페이지 => 마이페이지의 주문내역으로 // 서블릿\r\n");
      out.write("                location.href=\"/winefine/insertOrder.me?pickup=");
      out.print( pickup );
      out.write("&pickupDate=");
      out.print( pickupDate );
      out.write("&locationCode=");
      out.print( locationCode );
      out.write("&paymentCode=");
      out.print( paymentCode );
      out.write("\";\r\n");
      out.write("                \r\n");
      out.write("                // 구매한 장바구니의 제품 삭제 \r\n");
      out.write("                //~~~~~~~~~~~~~~~~~~~~~~~~~~~~ payThenDelete.ca 서블릿 만들어서 지울것\r\n");
      out.write("            } else {\r\n");
      out.write("                msg = '결제에 실패하였습니다.';\r\n");
      out.write("                msg += '에러내용 : ' + rsp.error_msg;\r\n");
      out.write("                //실패시 이동할 페이지 sendredirect 사용해보자\r\n");
      out.write("                location.href=\"/winefine/list.ca\";\r\n");
      out.write("                alert(msg);\r\n");
      out.write("            }\r\n");
      out.write("        });\r\n");
      out.write("        \r\n");
