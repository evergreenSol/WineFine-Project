             ...
             <div class="w_ body_3">
                ...
                <div>
                    ...
                    <div class="inroll">
                        ...
                        <form id="enroll-form" action="<%= contextPath%>/insert.re?pno=<%= p.getProductNo()%>" method="post" enctype="multipart/form-data">
                            <!-- 
				                                제목, 내용, 파일은 입력받고
                                ...
                                <tr>
                                    <td>제 &nbsp;목 : &nbsp;&nbsp; </td>
                                    <td><input type="text" name="reviewTitle" style="width:1100px;" minlength="10" required></td>
                                </tr>
                                <tr>
                                    <td>내 &nbsp;용 : &nbsp;&nbsp; </td>
                                    <td><textarea name="reviewContent" row="10" style="width:1100px; height: 200px; resize:none;" minlength="10" required 
                                        placeholder="고객님의 소중한 후기를 작성해주세요."></textarea></td>
                                </tr> 
                                <tr>
                                    <td>사진첨부: &nbsp;&nbsp; </td>
