               ...
               <td class="body_r">
                   <div class="delete">
						...
						<table class="order-detail">
							<tr height="100">
								<td rowspan="2" width="150"><img src="<%= op.getThumbnail() %>" alt="와인thumbnail" class="wineThumb" width="100%" onclick="bigImg(this.src)"></td>
						...
						<table class="order-detail">
								<tr>
									...
									<td width="700"></td>
									<td width="100"><%= o.getTotalPrice() %>원</td>
								</tr>
								<tr height="20"></tr>
								<tr>
									<td>결 제 정 보</td>
