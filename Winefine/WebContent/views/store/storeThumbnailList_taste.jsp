               ...
               <tr>
                    ...
                    <td class="body_r" style="width:950px; height: 1200px; position: absolute;">
                        ...
                        <div class="paging-area" style="padding-left:250px">
                            ...
                            <% if(currentPage != 1) {%>
                                <button class="btn-no" onclick="location.href='<%=contextPath%>/store.th_taste?currentPage=<%= currentPage-1 %>';">&lt;</button>
                            <%} %>
                                ...
                                <% for(int pNum = startPage; pNum <= endPage; pNum++) { %>
                                    ...
                                    <% if(pNum != currentPage){ %>
                                            <button class="btn-no" onclick="location.href='<%=contextPath%>/store.th_taste?currentPage=<%= pNum %>';"><%= pNum %></button>
                                    <%} else { %>
