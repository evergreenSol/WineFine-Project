...
/**
 * Servlet implementation class StoreListOriginController
 */
@WebServlet("/store.th_origin")
public class StoreListOriginController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public StoreListOriginController() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Product> list = new ProductService().sortProductOrigin(pn);
		...
		request.getRequestDispatcher("views/store/storeThumbnailList_origin.jsp").forward(request, response);
	}
