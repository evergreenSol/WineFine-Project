...
<body>
  ...
  <div style="width: 100%; height:950px;">
                                      ...
                                      <% for(Product p : list) { %>
	                                        <% if(p.getOrigin().equals("프랑스")) { %>
		                                      ...
		                                      <div class="Pthumbnail" align="center">
                                                <!-- <input id="origin" type="text" value="<%= p.getOrigin() %>"> -->
                        ...
                        <div class="paging-area" style="padding-left:250px">
                            ...
                            <% if(currentPage != 1) {%>
                                <button class="btn-no" onclick="location.href='<%=contextPath%>/store.th_origin?currentPage=<%= currentPage-1 %>';">&lt;</button>
                            <%} %>
                                ...
                                <% for(int pNum = startPage; pNum <= endPage; pNum++) { %>
                                    ...
                                    <% if(pNum != currentPage){ %>
                                            <button class="btn-no" onclick="location.href='<%=contextPath%>/store.th_origin?currentPage=<%= pNum %>';"><%= pNum %></button>
                                    <%} else { %>
