		...
		<br>
            ...
            <div class="w_ body_1" >
                ...
                <div class="float" style="width: 55%; padding: 20px;">
                    <table align="center;">
                        <tr>
                            <td style="border-bottom: 1px solid #BDBDBD; font-size: 12px;">상위카테고리 > 하위카테고리 > 상품명</td>
                        </tr>
                        <tr>
                            <td><br><h2>상품명</h2></td>
                        </tr>
                        <tr>
                            <td>4조 WINEFINE - 취하고싶조</td>
                        </tr>
                        <tr>
                            <td style="text-align: center;"><h4>29000원</h4></td>
                        </tr>
                        <tr>
                            <td style="border-bottom: 1px solid #BDBDBD;">도수 12.5 %<br><br></td>
                        </tr>
            ...
            <div class="w_ body_3">
                ...
                <div>
                    ...
                    <div class="inroll">
                        <!-- enctype="multipart/form-data" 작성해야만 파일 형식 그대로 서블릿으로 보내줌!(작성안하면 파일명만 넘어가는꼴)-->
                        <form id="enroll-form" action="<%= contextPath%>/insert.qn?pno=<%= p.getProductNo()%>" method="post" enctype="multipart/form-data">
                            <!-- 
				                                제목, 내용, 파일은 입력받고
				                                작성자 정보는 회원번호 hidden으로 넘기기
                                -->
                                <input type="hidden" name="userNo" value="<%= loginUser.getUserNo()%>">
                                <table>
                                <tr>
                                    <td>제 &nbsp;목 : &nbsp;&nbsp; </td>
                                    <td><input type="text" name="qnaTitle" style="width:1100px;" required></td>
                                </tr>

                                <tr>
                                    <td>내 &nbsp;용 : &nbsp;&nbsp; </td>
                                    <td><textarea row="10" name="qnaContent" style="width:1100px; height: 200px; resize:none;" minlength="10" required 
                                        placeholder="문의내용을 입력하세요."></textarea></td>
                                </tr> 

                                <tr>
                                    <td>사진첨부 : &nbsp;&nbsp; </td>
                                    <td><input type="file" name="qnaPhoto"></td>
                                </tr>
