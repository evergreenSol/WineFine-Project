       ...
       <div class="wrap">
           ...
           <div class="w_ top">
               ...
               <div class="w_" style="height: 90px;">
                    ...
                    <table>
                    <tr id="top_btn">
                            <td style="width:480px; font-size: 22px; font-weight: 600">이벤트 상세보기</td>
           ...
           <div class="w_ body">
            ...
            <div class="outer" align="center">
                ...
                <div align="center" id="bottom_btn">
                    <button type="button" class="btn1"><a href="<%= contextPath %>/Mmain.ev">목록으로</a></button>
                    <button type="button"><a href="<%= contextPath%>/updateForm.ev?eno=<%= e.getEventNo() %>">수정하기</a></button>
                    <button type="button"><a href="<%= contextPath%>/delete.ev?eno=<%= e.getEventNo() %>">삭제하기</a></button>
                </div>  
