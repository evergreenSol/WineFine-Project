       ...
       <div class="wrap">
           ...
           <div class="w_ top">
               ...
               <div class="w_" style="height: 90px;">
                    ...
                    <table>
                    <tr id="top_btn">
                            <td style="width:480px; font-size: 22px; font-weight: 600">공지사항 작성</td>
           ...
           <div class="w_ body">
            ...
            <div outer="outer" align="center">
                <br>
                <form id="insert-form" action="<%= contextPath %>/insert.no" method="post">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td height="500" align="center"><textarea name="content" placeholder="내용을 입력하세요." style="resize:none;" required></textarea></td>
                        </tr>
                    </table>
                    <br>
