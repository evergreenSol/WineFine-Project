...
<div class="outer">
    ...
    <div class="error- info">
        <div><h5>페이지가 존재하지 않거나 사용할 수 없는 페이지입니다.<br>
                                     입력하신 주소가 맞는지 다시 확인해 주시기 바랍니다.<br><br>
                 WINEFINE 이용에 불편을 드려 대단히 죄송합니다(_ _)</h5>
        </div>
        <div><br>
            <button class="btn btn-outline-primary" onclick="goBack();">뒤로 이동</button>
            <button class="btn btn-primary" onclick="mainPage();">메인 페이지로 이동</button>
        </div>
    </div>
    <script>
        function mainPage(){
