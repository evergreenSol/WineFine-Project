...
// 와인용어 상세보기 
/**
 * Servlet implementation class ThumbnailWineDetailController
 */
@WebServlet("/detail.bo")
public class ThumbnailWineDetailController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ThumbnailWineDetailController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	 // 와인용어 상세조회 
		...
		// 해당게시글에 딸린 첨부파일들 조회
		ArrayList<Brattachment> list = new BoardService().selectBrattachment(boardNo);
