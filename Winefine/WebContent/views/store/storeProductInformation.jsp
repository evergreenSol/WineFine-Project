 		...
 		<br>
             ...
             <div class="w_ body_3">
                ...
                <div class="pInformation">
                    ...
                    <br><br><br>
                        <b style="font-size:20px;">&nbsp;상품정보</b>
                        <br><br>
                    </div>
                    <div style="border-bottom: 1px solid #BDBDBD;">
                    <p>
                    	<br>
                        <li> 상품명 : <%= p.getProductName()%></li><br>
                        <li> 와인 타입 : <%= p.getProductType()%></li><br>
                        <li> 원산지 : <%= p.getOrigin()%></li><br>
                        <li> 알코올 도수 : <%= p.getAlcohol()%></li><br>
                        <li> 브랜드 : <%= p.getBrand()%></li><br>
                    </p>
                    </div>
                </div>
